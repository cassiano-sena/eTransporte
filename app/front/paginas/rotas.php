        ...
        <table class="table table-bordered">
            ...
            <?php
                ...
                if ($result) {
                    ...
                    <td>'.$horarios.'</td>
                    <td>
                    <button class="btn btn-primary"><a href="cadastro/upd_rota.php?updateid='.$id.'" class="text-light">Editar</a></button>
                    <button class="btn btn-danger"><a href="rotas.php?deleteid='.$id.'" class="text-light">Remover</a></button>
                    </td>
                </tr>';
                    }
                } else{

<?php
    class Rota{
        ...
        public function getAllRotas(){
            $stmt=$this->dbConn->prepare('SELECT * FROM '.$this->tableName.' WHERE rota_status = :rota_status');
        ...
        public function insert(){
            $sql='INSERT INTO '.$this->tableName.'(rota_id, rota, veiculo, motorista, datas, horarios, rota_status, created_on, imagem) VALUES(null, :rota, :veiculo, :motorista, :datas, :horarios, :rota_status, :created_on, :imagem)';

...
INSERT INTO `tab_usuarios` (`usuario_id`,`nome`,`email`,`telefone`,`senha`,`is_admin`,`is_driver`,`is_active`,`usuario_status`, `cidade`) VALUES
(1,'Cassiano','cassiano@email.com','1234-5678','Cassiano','1','0','0','A','Porto-Belo'),
(2,'Eduardo','eduardo@email.com','1234-5678','Eduardo','0','1','0','A','Tijucas'),
(3,'Motorista 1','motorista1@email.com','1234-5678','motorista','0','1','0','A','Porto-Belo'),
(4,'Motorista 2','motorista2@email.com','1234-5678','motorista','0','1','0','A','Porto-Belo');

INSERT INTO `tab_rotas` (`rota_id`,`rota`,`veiculo`,`motorista`,`datas`,`horarios`,`rota_status`) VALUES
(1,'Itapema-Itajaí','1','3','Seg-Sex','18:00, 22:00','A'),
(2,'Tijucas-Itajaí','2','4','Seg-Sex','18:00, 22:00','A');
